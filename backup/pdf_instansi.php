  ...
  <page_header>
    ...
    <table class="page_header">
      <tr>
        ...
        <td style="text-align: center;    width: 80%">LAPORAN INSTANSI</td>
  ...
  <table class="tabel2" style="border-collapse: collapse;" border="1">
    <thead>
      <tr>
        ...
        <td style="text-align: center; padding: 5px; background: #ddd; width: 20%"><b>Nama Instansi</b></td>
        <td style="text-align: center; padding: 5px; background: #ddd; width: 30%"><b>Alamat</b></td>
        <td style="text-align: center; padding: 5px; background: #ddd; width: 15%"><b>Kota</b></td>
        <td style="text-align: center; padding: 5px; background: #ddd; width: 25%"><b>Telp</b></td>
      </tr>
    </thead>
    <tbody>
      <?php
      $sql = mysqli_query($con, "SELECT instansi_id, nama_instansi, alamat, kota, telp FROM instansi");  
      $i   = 1;
      ...
      <tr>
        ...
        <td style="text-align: center; padding: 5px;"><?php echo $data['alamat']; ?></td>
        <td style="text-align: center; padding: 5px;"><?php echo $data['kota']; ?></td>
        <td style="text-align: center; padding: 5px;"><?php echo $data['telp']; ?></td>
      </tr>
    <?php
    $i++;
    }
 ...
 try
{
    ...
    ob_end_clean();
    $html2pdf->Output('Laporan_Instansi.pdf');
}
