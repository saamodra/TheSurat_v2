...
INSERT INTO `block_ip` (`blockip_id`, `ip`, `keterangan`) VALUES (3,'192.168.11.29','ahdhads');
...
INSERT INTO `identitas` (`identitas_id`, `nama_identitas`, `alamat`, `kota`, `telp`, `website`, `pemilik`, `keuangan`, `logo_kiri`, `logo_kanan`) VALUES (1,'SMK Negeri 1 Jenangan','Jl. Niken Gandini No. 98, Setono, Jenangan','Ponorogo','352481236','www.smkn1jenpo.sch.id','-','-','karawang_tuparev_wpap_by_jodiartzdbtlu9b.jpg','karawang_tuparev_wpap_by_jodiartzdbtlu9b.jpg');
...
INSERT INTO `user` (`user_id`, `password`, `level`, `nama`) VALUES ('admin','c3284d0f94606de1fd2af172aba15bf3','Admin','Admin'),('iankco46@gmail.com','iankco','User','Muh. Hardiansah'),('muhammadadimas20@gmail.com','Adimas20','User','Adimas'),('samodra30@gmail.com','Samodra','Admin','Samodra'),('Shinigami12','Shinigami12','User','Shinigami'),('user','user','User','User');
...
-- Dump completed on 2018-05-04 13:56:42
