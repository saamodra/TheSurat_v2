  ...
  <page_header>
    ...
    <table class="page_header">
      <tr>
        ...
        <td style="text-align: center;    width: 80%">LAPORAN LOKASI</td>
  ...
  <table class="tabel2" style="border-collapse: collapse;" border="1">
    <thead>
      <tr>
        ...
        <td style="text-align: center; padding: 5px; background: #ddd; width: 45%"><b>Lokasi Pengarsipan</b></td>
        <td style="text-align: center; padding: 5px; background: #ddd; width: 50%"><b>Keterangan</b></td>
      </tr>
    </thead>
    <tbody>
      <?php
      $sql = mysqli_query($con, "SELECT lokasi_id, lokasi, keterangan FROM lokasi");  
      $i   = 1;
 ...
 try
{
    ...
    ob_end_clean();
    $html2pdf->Output('Laporan_Lokasi.pdf');
}
