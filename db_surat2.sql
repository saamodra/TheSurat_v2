...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2018 at 10:22 AM
...
(1, 'SMK Negeri 1 Jenangan', 'Jl. Niken Gandini No. 98, Setono, Jenangan', 'Ponorogo', '352481236', 'www.smkn1jenpo.sch.id', '-', '-', 'logo.smk.jenangan.png', 'logo.smk.jenangan.png');
...
(14, '8920', 2, 'BIASA', 'hjghjg', '2018-04-20', '2018-04-14', '2018-04-19', '89098', 'db_surat2.sql', 'hjhkj', 'fggfhf', 1, 2, 'PERLU TINDAK LANJUT', 2, 'samodra30', NULL),
...
(22, '789798', 5, 'BIASA', 'Keuangan', '2018-04-07', '2018-04-13', '2018-04-20', '21', 'Menu.docx', 'sadas', 'sahdkj', 6, 4, 'PERLU TINDAK LANJUT', 3, 'admin', '2018-04-28 03:38:39');
...
('iankco', 'iankco', 'User', 'Muh. Hardiansah'),
('samodra30', 'Samodra', 'Admin', 'Samodra'),
('Shinigami12', 'Shinigami12', 'User', 'Shinigami'),
('user', 'user', 'User', 'User');
...
--
ALTER TABLE `surat_keluar`
  MODIFY `surat_keluar_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `surat_masuk`
--
ALTER TABLE `surat_masuk`
  MODIFY `surat_masuk_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
