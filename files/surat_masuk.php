		...
		<div class="row">
			<div class="col-lg-8">
				<form class="form-horizontal" method="get" action="index.php">
					<input type="hidden" name="file" value="surat_masuk">
				...
				<div>
					<ul class="pagination">
						...
						<li class="page-item active">
							...
							?>
						<li class="page-item">
							<a class="page-link" href="index.php?file=surat_masuk&cari=<?php echo $cari;?>&hal=<?php echo $i;?>"><?php echo $i;?></a>
						</li>
						<?php
							} #_end IF
						}
