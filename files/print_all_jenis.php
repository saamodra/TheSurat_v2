...
<html>
<head>
  <title>Laporan Jenis Surat</title>
  <style type="text/css">
    #myTable, th, td{
  ...
  <div class="container-fluid" id="container">
    <div class="col-lg-12">
            <?php
              ...
              session_start();
              write_log('Print Data Jenis Surat ('.$_SESSION['user_id'].')');
              mysqli_query($con2, "insert into log(userid, menu, ip, log) values ('".$_SESSION['user_id']."','Jenis Surat','$ip','Print Data Jenis Surat (".$_SESSION['user_id'].")')");
            ?>
          <table class="table-responsive">
            ...
            <center><h3 align="center">Data Jenis Surat</h3></center>
