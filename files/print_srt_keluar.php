...
<body onload="printData();">
    ...
    <div class="col-lg-12">
          ...
          <table class="table-responsive">
            ...
            <center><h3 align="center">Data Surat Keluar</h3></center><br><br>
          <table class="table-responsive" style="text-align: left; font-size: 20px;">
            <tr>
              <td style="padding-left: 80px; border: none;">Nomor Surat</td>
              <td style="border: none; padding-right: 50px;">:</td>
              <td style="border: none; padding-right: 80px;"><?php echo $row2->nomor_surat; ?></td>
            </tr>
            <tr>
              <td style="padding-left: 80px; border: none;">Bagian Penerima</td>
              <td style="border: none;">:</td>
              <td style="border: none;"><?php echo $row2->bagian; ?></td>
            </tr> 
            <tr>
              <td style="padding-left: 80px; border: none;">Sifat</td>
              <td style="border: none;">:</td>
              <td style="border: none;"><?php echo $row2->sifat; ?></td>
            </tr> 
            <tr>
              <td style="padding-left: 80px; border: none;">Perihal</td>
              <td style="border: none;">:</td>
              <td style="border: none;"><?php echo $row2->perihal; ?></td>
            </tr> 
            <tr>
              <td style="padding-left: 80px; border: none;">Tanggal Surat</td>
              <td style="border: none;">:</td>
              <td style="border: none;"><?php echo $row2->tanggal_surat; ?></td>
            </tr> 
            <tr>
              <td style="padding-left: 80px; border: none;">Tanggal Kirim</td>
              <td style="border: none;">:</td>
              <td style="border: none;"><?php echo $row2->tanggal_kirim; ?></td>
            </tr>
            <tr>
              <td style="padding-left: 80px; border: none;">Nomor Agenda</td>
              <td style="border: none;">:</td>
              <td style="border: none;"><?php echo $row2->nomor_agenda; ?></td>
            </tr> 
            <tr>
              <td style="padding-left: 80px; border: none;">Lampiran</td>
              <td style="border: none;">:</td>
              <td style="border: none;"><?php echo $row2->lampiran; ?></td>
            </tr> 
            <tr>
              <td style="padding-left: 80px; border: none;">Disposisi</td>
              <td style="border: none;">:</td>
              <td style="border: none;"><?php echo $row2->disposisi; ?></td>
            </tr> 
            <tr>
              <td style="padding-left: 80px; border: none;">Tembusan</td>
              <td style="border: none;">:</td>
              <td style="border: none;"><?php echo $row2->tembusan; ?></td>
            </tr> 
            <tr>
              <td style="padding-left: 80px; border: none;">Instansi Pengirim</td>
              <td style="border: none;">:</td>
              <td style="border: none;"><?php echo $row2->nama_instansi; ?></td>
            </tr> 
            <tr>
              <td style="padding-left: 80px; border: none;">Jenis Surat</td>
              <td style="border: none;">:</td>
              <td style="border: none;"><?php echo $row2->jenis; ?></td>
            </tr>
            <tr>
              <td style="padding-left: 80px; border: none;">Lokasi Pengarsipan</td>
              <td style="border: none;">:</td>
