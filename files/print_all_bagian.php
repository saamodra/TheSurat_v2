...
<body onload="printData();">
    ...
    <div class="col-lg-12">
            <?php
              ...
              write_log('Print Data Bagian ('.$_SESSION['user_id'].')');
			    mysqli_query($con2, "insert into log(userid, menu, ip, log) values ('".$_SESSION['user_id']."','Bagian','$ip','Print Data Bagian (".$_SESSION['user_id'].")')");
			            ?>
