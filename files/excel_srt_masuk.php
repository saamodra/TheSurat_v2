...
write_log('Export Excel Surat Masuk');
mysqli_query($con2, 'insert into log(userid, menu, ip, log) values ("'.$_SESSION['user_id'].'","Surat Masuk","'.$ip.'","Export Excel Surat Masuk")');
?>
<div class="container-fluid" id="container">
    <div class="col-lg-12" id="myTable">
          ...
          <table class="table-responsive">
            <tr>
              <td align="center" colspan="16"><h2><?php echo $row->nama_identitas; ?></h2></td>
            </tr>
            <tr>
              <td align="center" valign="top" colspan="16"><h6><?php echo $row->alamat; ?></h6></td>
            </tr>
            <tr>
				<td colspan="16" align="center" style="vertical-align: middle;"><h4>Data Surat Masuk</h4></td>
			</tr> 
          </table>  
