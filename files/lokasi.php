...
mysqli_query($con2, "insert into log(userid, menu, ip, log) values ('$id_user','Lokasi','$ip','Buka Halaman Lokasi ($id_user)')");
		...
		<div class="row">
			<div class="col-lg-6">
				<form class="form-horizontal" method="get" action="index.php">
					<input type="hidden" name="file" value="lokasi">
				...
				<div>
					<ul class="pagination">
						...
						<li class="page-item active">
							...
							?>
						<li class="page-item">
							<a class="page-link" href="index.php?file=lokasi&cari=<?php echo $cari;?>&hal=<?php echo $i;?>"><?php echo $i;?></a>
						</li>
						<?php
							} #_end IF
						}
